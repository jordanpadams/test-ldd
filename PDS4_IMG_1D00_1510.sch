<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:img  Version:1.5.1.0 - Fri May 01 04:34:46 UTC 2020 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="/pds:Product_Observational/pds:Observation_Area/pds:Discipline_Area/img:Command_Parameters">
      <sch:report test="exists(/pds:Product_Observational/pds:Observation_Area/pds:Discipline_Area/img:Command_Parameters)">
        insight:log:cmd_params_0: Validating img:Command_Parameters
        class</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="/pds:Product_Observational/pds:Observation_Area/pds:Discipline_Area/img:Image_Product_Information/img:Data_Correction_Parameters">
      <sch:report test="exists(/pds:Product_Observational/pds:Observation_Area/pds:Discipline_Area/img:Image_Product_Information/img:Data_Correction_Parameters)">
        insight:log:data_corr_params_0: Validating img:Data_Correction_Parameters
        class</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="img:Downsampling_Parameters/img:downsampling_venue">
      <sch:assert test="if (not(@xsi:nil eq 'true') and (not(. = ('Both', 'Hardware', 'Software')))) then false() else true()">
        The attribute img:downsampling_venue must be nulled or equal to one of the following values 'Both', 'Hardware', 'Software'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="/pds:Product_Observational/pds:Observation_Area/pds:Discipline_Area/img:Imaging_Instrument_State_Parameters/img:Instrument_Device_Temperature">
      <sch:report test="exists(/pds:Product_Observational/pds:Observation_Area/pds:Discipline_Area/img:Imaging_Instrument_State_Parameters/img:Instrument_Device_Temperature)">
        insight:log:inst_device_temp_0: Validating img:Instrument_Device_Temperature
        class</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="/pds:Product_Observational/pds:Observation_Area/pds:Discipline_Area/img:Image_Product_Information/img:Subframe_Parameters">
      <sch:report test="exists(/pds:Product_Observational/pds:Observation_Area/pds:Discipline_Area/img:Image_Product_Information/img:Subframe_Parameters)">
        insight:log:subframe_params_0: Validating img:Subframe_Parameters
        class</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
